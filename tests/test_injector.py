...
class TestInjector:
    ...
    def test_injector_device_auto_detection(self, simple_model, sample_data):
        ...
        assert injector.device in ["cuda", "cpu"]
    ...
    def test_get_criterion_score(self, simple_model, sample_data, device):
        ...
        score1 = injector.get_criterion_score()
    ...
    def test_run_seu_layer_filtering(self, simple_model, sample_data, device):
        ...
        results_empty = injector.run_seu(bit_i=0, layer_name__="nonexistent_layer")
        ...
        results_first = injector.run_seu(bit_i=0, layer_name__="0.weight")
    ...
    def test_run_stochastic_seu_basic(self, simple_model, sample_data, device):
        ...
        results = injector.run_stochastic_seu(bit_i=0, p=0.5)
    ...
    def test_run_stochastic_seu_probability_validation(self, simple_model, sample_data, device):
        ...
        for p in [0.0, 0.1, 0.5, 1.0]:
            results = injector.run_stochastic_seu(bit_i=0, p=p)
            assert isinstance(results, dict)
    ...
    def test_stochastic_seu_probability_effects(self, simple_model, sample_data, device):
        ...
        np.random.seed(42)
        results_low = injector.run_stochastic_seu(bit_i=0, p=0.1)
        
        np.random.seed(42)  
        results_high = injector.run_stochastic_seu(bit_i=0, p=0.9)
    ...
    def test_run_stochastic_seu_layer_filtering(self, simple_model, sample_data, device):
        ...
        results = injector.run_stochastic_seu(bit_i=0, p=1.0, layer_name__="0.weight")
        ...
        results_empty = injector.run_stochastic_seu(bit_i=0, p=1.0, layer_name__="nonexistent_layer")
