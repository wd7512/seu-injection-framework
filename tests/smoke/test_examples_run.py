...
# Files generated by example scripts during smoke tests.
# Cleaned up by the autouse fixture below.
_ARTIFACTS = [
    REPO_ROOT / "cnn_robustness_analysis.png",                           # basic_cnn_robustness.py
    EXAMPLES_DIR / "flood_training_study" / "flood_training_seu_robustness.png",  # experiment.py
    REPO_ROOT / "architecture_comparison.png",                           # architecture_comparison.py
    REPO_ROOT / "architecture_comparison_report.txt",                    # architecture_comparison.py
]


@pytest.fixture(autouse=True)
def cleanup_artifacts():
    """Remove plot/report files generated by example scripts after each test."""
    yield  # run the test
