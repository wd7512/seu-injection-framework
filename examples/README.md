...
- **[flood_training_study/](flood_training_study/)**: **NEW** - Comprehensive research study on how flood level training improves SEU robustness by 9.7% with only 0.5% accuracy cost (19.5× ROI). Includes full research paper (6 sections), implementation guide, working code, and experimental results with visualizations. Demonstrates that training methodology matters for radiation tolerance. See [README](flood_training_study/README.md) for the complete study.
