...
def main():
    ...
    print(f"  4. Robustness gain is {robustness_improvement / (accuracy_diff * 100):.1f}× larger than accuracy loss" if accuracy_diff != 0 else "  4. Robustness gain achieved with no accuracy loss")
