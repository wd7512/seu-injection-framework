...
1. **Flood Training**: Maintain flood levels `b ∈ [0.05, 0.10, 0.15, 0.20, 0.30]` during training
...
1. **Mean Accuracy Drop**:

   ```
   Drop = baseline_accuracy - MAUI
   ```

1. **Critical Fault Rate (CFR)**:
